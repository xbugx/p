curl -o ~/Downloads/node_exporter-1.4.0.darwin-amd64.tar.gz -L https://github.com/prometheus/node_exporter/releases/download/v1.4.0/node_exporter-1.4.0.darwin-amd64.tar.gz
cd ~/Downloads
